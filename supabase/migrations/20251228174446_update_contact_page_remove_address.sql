/*
  # Update Contact Page - Remove Physical Address

  This migration updates the contact page to remove the "Visit Us" section
  with physical address, as requested by the user.
*/
