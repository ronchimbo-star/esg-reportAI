...
import { Mail, Eye, Trash2, X, Check } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
                  ...
                  <tr key={submission.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-4 py-4 whitespace-nowrap text-right">
                      <div className="flex items-center justify-end gap-2">
                        ...
                        <button
                          onClick={() => promptDelete(submission.id, submission.name)}
            ...
            <div className="relative bg-white rounded-xl shadow-2xl max-w-3xl w-full max-h-[90vh] overflow-y-auto">
              ...
              <div className="p-6 space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1">Form Source</label>
                    <p className="text-gray-900 text-sm">
                      <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
                        {selectedSubmission.form_source === 'pricing_page' ? 'Pricing Page' :
                         selectedSubmission.form_source === 'contact_page' ? 'Contact Page' :
                         selectedSubmission.form_source || 'Unknown'}
                      </span>
                    </p>
                  </div>
                </div>
              ...
              <div className="sticky bottom-0 bg-gray-50 border-t border-gray-200 px-6 py-4 flex items-center justify-between gap-4">
                <button
                  onClick={() => promptDelete(selectedSubmission.id, selectedSubmission.name)}
      ...
      <ConfirmDialog
        ...
        message={`Are you sure you want to delete the submission from "${submissionToDelete?.name}"? This action cannot be undone.`}
        confirmText="Delete"
        cancelText="Cancel"
        variant="danger"
